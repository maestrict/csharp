...
Account account1 = new CurrentAccount("2",12345,100,pers1);
Account account2 = new CurrentAccount("1",12345,100,pers1);
Account account3 = new CurrentAccount("3",12345,100,pers2);
